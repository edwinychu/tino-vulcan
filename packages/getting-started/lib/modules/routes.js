...
addRoute({ name: 'step2', path: '/step/2', componentName: 'Step2' }); 
addRoute({ name: 'step3', path: '/step/3', componentName: 'Step3' }); 
addRoute({ name: 'step4', path: '/step/4', componentName: 'Step4' });  
